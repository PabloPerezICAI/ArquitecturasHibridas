...
java -jar /home/shared/export.jar -c elastic:**** -f '@timestamp' -from $fechaAyer -i 'index-data' -k $keystore -o $nombreFichero -s icai4ever -to $fechaHoy -u https://localhost:9216
